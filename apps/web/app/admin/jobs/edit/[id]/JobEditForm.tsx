...
export default function JobEditForm({ job, id }: { job: Job | null; id: string }) {
  ...
  async function loadJob() {
    try {
      ...
      // Convert date format for the input field (if possible)
      let dateForInput = '';
      try {
        // Try to parse the date string (e.g., "December 7, 2024")
        const date = new Date(loadedJob.date);
